...
(function () {
  ...
  var TOPICS = {
    curriculum: {
      ...
      note: '(1) 通級による指導（学校教育法施行規則 第140条・第141条）：障害のある幼児児童生徒が対象。自立活動の内容を参考に指導する。' +
    ...
    seito: {
      ...
      noteHead: '障害のある幼児児童生徒がこれらの課題に直面している場合',
  ...
  function renderSheet2() {
    ...
    var html = '<div class="jiritsu-table-wrap sp-view s2-view">' +
      ...
      '<div class="overview">通級による指導・日本語指導・不登校・特定分野に特異な才能の計画を、「共通シート」と「特例ごとの個別シート」で一枚にまとめる様式（いわゆる2階シート）です。' +
        '複数の特例に該当する幼児児童生徒を一枚で俯瞰するために使います。自立活動の項目そのものを選ぶ道具ではなく、選んだ項目を含む計画を書く道具です。項目を選ぶには<a href="' + ROUTES.support() + '">サポートシート</a>を。</div>' +
  ...
  function renderTopicItem(t, h) {
    ...
    var jiritsuLine = (t.key === 'seito')
      ? '<div class="section-disclaimer"><b>障害のある幼児児童生徒がこの課題に直面している場合の自立活動</b>' +
